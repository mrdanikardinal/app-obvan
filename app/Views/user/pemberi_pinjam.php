    ...
    <?php foreach ($showGetPeminjamanAlatJoinUsers as $key => $valueShowPeminjamanAlat) : ?>
       ...
       $bulan_huruf_number = array(
        ...
        <nav>
            ...
            <h5>No: <?= ($valueShowPeminjamanAlat['nomor_surat_pemberi'] == NULL) ? $autoNomorSurat  : $valueShowPeminjamanAlat['nomor_surat_pemberi']; ?>/ <?=$getKlasifikasiSuratPemberi['kode_klasifikasi'];?>/<?=$getKodeObvan['kode_klasifikasi_obvan'];?>/<?=$bulanForTandaTanganCount;?>/<?=$yearForTandaTanganCount;?></h5>
