...
<body>
    <?php foreach ($showAllDinasShiftingJoinIdDinasIdShifIdAcara as $key => $valueDinasShift) : ?>
        ...
        <nav>
            ...
            <h5>No: <?= ($valueDinasShift['nomor_surat'] == NULL) ? $autoNomorSurat  : $valueDinasShift['nomor_surat']; ?>/ TK.02.02/1.4.3.2/II/<?= $tahun; ?></h5>
...
<span> TEMPAT      : <?= $valueDinasShift["lokasi"]; ?></span>
                ...
                <?php endforeach; ?>
                <h5>Satuan kerja Teknik Produksi Peralatan Luar Studio dengan ini menugaskan crew produksi dalam studio & penyiaran sebagai berikut:
                    <h6>
            </div>
        </nav>
        <section>
