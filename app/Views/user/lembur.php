...
<body>
    <?php foreach ($showAllDinasShiftingJoinIdDinasIdShifIdAcara as $key => $valueDinasShift) : ?>
        ...
        <nav>
            ...
            <h4>No: <?= ($valueDinasShift['nomor_surat_lembur'] == NULL) ? $autoNomorSurat  : $valueDinasShift['nomor_surat_lembur']; ?>/ TK.02.02/1.4.3.2/II/<?= $tahun; ?></h4>
...
<span> TEMPAT      : <?= $valueDinasShift["lokasi"]; ?></span>
        ...
        <?php endforeach; ?>
        <h4>Satuan kerja Teknik Produksi Peralatan Luar Studio dengan ini menugaskan crew lembur sebagai berikut: </h4>
        </nav>
        <section>
