    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                ...
                <a href="<?= base_url() ?>admin/kelola-surat-tugas-lembur" class="btn btn-primary my-2">Refresh</a>
                            ...
                            <tbody>
                                ...
                                <?php foreach ($allDataJoinShiftDanJoinNamaAcara as $key => $valueDinasShift) : ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?= ($valueDinasShift['nomor_surat_lembur'] !== NULL) ? '<div class="badge bg-primary text-wrap" style="width: 8rem; height: 2rem"><h6>' . $valueDinasShift['nomor_surat_lembur'] . '</h6></div>' : '<div class="badge bg-danger text-wrap" style="width: 8rem; height: 2rem"><h6>Kosong</h6></div>'; ?>
                                        </td>
                                        <td>
                                            <a href="<?= base_url() ?>admin/kelola-surat-tugas-lembur/edit-nomor-surat-lembur/<?= $valueDinasShift['id_dinas_shifting']; ?>" class="btn btn-primary my-2"><i class="fa-regular fa-pen-to-square"></i>Edit.No.Surat</a>
                                        </td>
                                        <td>
